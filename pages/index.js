...
export default function Home() {
  ...
  const contractAddress = '0x157F9B38C2381280319217b99966d30C4f12Bc73';
  ...
  //We have a useEffect so that getConnectedAccount function runs on the client when the page is loaded.
